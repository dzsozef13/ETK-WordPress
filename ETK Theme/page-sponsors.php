...
<div class="row post">
    ...
    <div class="row post-content" style="background-color: #eee;">
        <div class="col-xl-8 col-md-8 col-sm-12" style="padding: 32px">
			...
			<a href="https://www.jyskebank.dk" style="color:#E31F25;">jyskebank.dk</a>
			<h4 style="margin-bottom: 16px; margin-top: 32px;"> <?php the_field("main_sponsors_title_2") ?> </h4>
            <h6> <?php the_field('main_sponsors_text_2') ?> </h6>
			<a href="https://www.intersport.dk" style="color:#E31F25;">intersport.dk</a>
        </div>
